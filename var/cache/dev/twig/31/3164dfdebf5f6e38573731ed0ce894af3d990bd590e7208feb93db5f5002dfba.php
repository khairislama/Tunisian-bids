...
class __TwigTemplate_f0317e1aace3128e73cdfc5cad917eaca6330e04f1ac85f4c80c1c0cd94383a4 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    <h1>";
        ...
        echo " By ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 8, $this->source); })()), "user", [], "any", false, false, false, 8), "email", [], "any", false, false, false, 8), "html", null, true);
        echo "</h1>
    <img class=\"img-fluid img-thumbnail rounded\" 
        src=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Vich\UploaderBundle\Twig\Extension\UploaderExtension']->asset((isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 10, $this->source); })()), "imageFile"), "html", null, true);
        echo "\">
    </img>    
</div>
";
    ...
    {
        return array (  100 => 10,  93 => 8,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
    <h1>{{ product.name }} By {{ product.user.email }}</h1>
    <img class=\"img-fluid img-thumbnail rounded\" 
